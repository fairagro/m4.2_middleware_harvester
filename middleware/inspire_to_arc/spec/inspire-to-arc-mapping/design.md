...
> [!NOTE]
> All conceptual design mapping decisions—why spatial elements become protocols or why online resources flatten into Assay tables—are documented globally in [docs/inspire_to_arc_mapping.md](../../../../docs/inspire_to_arc_mapping.md).
