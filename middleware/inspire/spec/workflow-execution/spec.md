...
- [ ] Export an asynchronous function `run_plugin(config: Config) -> AsyncGenerator[str | HarvesterError, None]` from `plugin.py` to serve as the integration point for the central Harvester.
