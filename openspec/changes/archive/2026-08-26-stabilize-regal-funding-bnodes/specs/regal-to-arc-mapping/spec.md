...
obtained via the mapper's single- and multi-value string helpers) MUST NOT return or embed rdflib blank-node labels (`N`
plus 32 hex digits, or `_:…`). For each RDF object:
...
[`docs/regal_mapping.md`](../../../../docs/regal_mapping.md) §6.
