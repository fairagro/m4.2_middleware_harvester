...
[`docs/regal_mapping.md`](../../../../docs/regal_mapping.md), `contributorOrder` is intended to order Contacts when
stable order keys are available; implementing that ordering is optional for this change and MUST NOT use blank-node
strings as order keys.
