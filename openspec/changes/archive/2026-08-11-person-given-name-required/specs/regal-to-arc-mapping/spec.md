...
Authoritative field tables remain in [docs/regal_mapping.md](../../../../docs/regal_mapping.md); this requirement
overrides any reading that allows empty FirstName on contacts.
