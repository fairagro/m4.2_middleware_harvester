...
The system SHALL define a `PayloadKind` enumeration identifying supported intermediate payload formats. v1 MUST include
`rdf_graph` (value type: RDF graph). Additional kinds MAY be added in later changes without changing the discriminator
mechanism.
