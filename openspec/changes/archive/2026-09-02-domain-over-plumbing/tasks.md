...
- [x] 1.3 Extend Module Dependency Graph with Linked Data `plugin.py` → `pipeline.py` (and note that pipeline MUST NOT
      perform mapping)
- [x] 1.4 Merge the ADDED requirement _Separate domain logic from technical plumbing_ into the Requirements section of
      `openspec/specs/principles/spec.md`
