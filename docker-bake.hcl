...
target "harvester-wheels" {
  ...
  args = {
    ...
    UV_BUILD_PACKAGES = "inspire harvester linked_data generic payload"
  }
}
...
target "harvester-base" {
  ...
  args = {
    ...
    EXTRA_PYINSTALLER_ARGS = "--copy-metadata harvester --copy-metadata inspire --copy-metadata linked_data --copy-metadata generic --copy-metadata payload --copy-metadata fairagro-middleware-api-client --copy-metadata fairagro-middleware-shared"
  }
}
